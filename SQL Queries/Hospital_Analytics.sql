...
-- Query-14) Calculate the readmission rate: patients who had another visit within 30 days of a discharge.
select * from Doctors;
select * from ER_Shifts;
select * from Patients;
select * from Treatments;
select * from Visits;


-- Query-15) Flag any visit where a treatment occurred after discharge time.
-- Query-16) For each severity level, find the 95th percentile of waiting time.
-- Query-17) Identify any doctors who haven’t logged a successful treatment in the last 90 days.
-- Query-18) List all patients who were treated by more than 3 different doctors in a single month.